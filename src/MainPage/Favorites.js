...
const Favorites = () => {
    ...
    return (
        <div className="favorites-container" ref={favoriteRef}>
            <h2 className="favorite-text-positioning">
                Some of Our Favorite Pieces
            </h2>
            <div className="slide-container">
                {isDesktopSize ? (
                    <div className="favorite-desktop">{favorites}</div>
                ) : (
                    <Slider items={favorites} />
                )}
            </div>
            <a
                href="/products"
                className="favorite-text-positioning favorite-button"
            >
                Shop All
            </a>
        </div>
